...
b1 = plt.bar(index, new_designed_rosetta_mean_aa_freqs, width, color = "#E69F00")                                                                        
b2 = plt.bar(index+width, new_designed_evolved_mean_aa_freqs, width, color = "#0072B2")                                                                
b3 = plt.bar(index+width+width, new_natural_mean_aa_freqs, width, color = "#009E73")                                                                      
...
b4 = plt.bar(index, new_designed_rosetta_surface_mean_freqs, width, color = "#E69F00")                                                                   
b5 = plt.bar(index + width, new_designed_evolved_surface_mean_freqs, width, color = "#0072B2")                                                         
b6 = plt.bar(index + width + width, new_natural_surface_mean_freqs, width, color = "#009E73")                                                             
...
b7 = plt.bar(index, new_designed_rosetta_buried_mean_freqs, width, color = "#E69F00")                                                                    
b8 = plt.bar(index + width, new_designed_evolved_buried_mean_freqs, width, color = "#0072B2")                                                          
b9 = plt.bar(index + width + width, new_natural_buried_mean_freqs, width, color = "#009E73")                                                              
